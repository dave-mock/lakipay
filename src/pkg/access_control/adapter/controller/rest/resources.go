...
func (controller Controller) CreateResource(w http.ResponseWriter, r *http.Request) {
	...
	resource, err := controller.interactor.CreateResource(req.Name, req.Description)
	if err != nil {
		SendJSONResponse(w, Response{
			Success: false,
			Error: &Error{
...
func (controller Controller) UpdateResource(w http.ResponseWriter, r *http.Request) {
	...
	resource, err := controller.interactor.UpdateResource(req.ResourceID, req.Name, req.Description)
	if err != nil {
